...
> **Note**: The visual editor (`Editor/editor.html`) requires none of the above — just open it directly in a browser.
...
2. **Open and work**: Double-click `Editor/editor.html` in your browser, enter your token and repository name, then import the `[Topic]_EliteNetwork_Viewer.html` generated by the Agentic Workflow to get started.
